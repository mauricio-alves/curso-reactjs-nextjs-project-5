...
describe('<Heading />', () => {
  ...
  it('should render correct font-size when using mobile screen', () => {
    renderTheme(<Heading size="huge">texto</Heading>);
    screen.getByRole('heading', { name: 'texto' });

    expect(screen.getByRole('heading', { name: 'texto' })).toHaveStyleRule('font-size', theme.font.size.xlarge, {
